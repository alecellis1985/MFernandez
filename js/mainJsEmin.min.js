...
i.close(e,!0)),n.attr("title")&&(n.uniqueId(),i.parents[this.id]={element:this,title:n.attr("title")},n.attr("title",""))}),this._updateContent(n,e))},_updateContent:function(t,e){var i,n=this.options.content,s=this,o=e?e.type:null;if("string"==typeof n)return this._open(e,t,n);(i=n.call(t[0],function(i){t.data("ui-tooltip-open")&&s._delay(function(){e&&(e.type=o),this._open(e,t,i)})}))&&this._open(e,t,i)},_open:function(e,i,n){function s(t){h.of=t,o.is(":hidden")||o.position(h)}var o,a,r,l,h=t.extend({},this.options.position);if(n){if(o=this._find(i),o.length)return void o.find(".ui-tooltip-content").html(n);i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),o=this._tooltip(i),this._addDescribedBy(i,o.attr("id")),o.find(".ui-tooltip-content").html(n),this.liveRegion.children().hide(),n.clone?(l=n.clone(),l.removeAttr("id").find("[id]").removeAttr("id")):l=n,t("<div>").html(l).appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:s}),s(e)):o.position(t.extend({of:i},this.options.position)),this.hiding=!1,this.closing=!1,o.hide(),this._show(o,this.options.show),this.options.show&&this.options.show.delay&&(r=this.delayedShow=setInterval(function(){o.is(":visible")&&(s(h.of),clearInterval(r))},t.fx.interval)),this._trigger("open",e,{tooltip:o}),a={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var n=t.Event(e);n.currentTarget=i[0],this.close(n,!0)}}},i[0]!==this.element[0]&&(a.remove=function(){this._removeTooltip(o)}),e&&"mouseover"!==e.type||(a.mouseleave="close"),e&&"focusin"!==e.type||(a.focusout="close"),this._on(!0,i,a)}},close:function(e){var i=this,n=t(e?e.currentTarget:this.element),s=this._find(n);this.closing||(clearInterval(this.delayedShow),n.data("ui-tooltip-title")&&!n.attr("title")&&n.attr("title",n.data("ui-tooltip-title")),this._removeDescribedBy(n),this.hiding=!0,s.stop(!0),this._hide(s,this.options.hide,function(){i._removeTooltip(t(this)),this.hiding=!1,this.closing=!1}),n.removeData("ui-tooltip-open"),this._off(n,"mouseleave focusout keyup"),n[0]!==this.element[0]&&this._off(n,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,function(e,n){t(n.element).attr("title",n.title),delete i.parents[e]}),this.closing=!0,this._trigger("close",e,{tooltip:s}),this.hiding||(this.closing=!1))},_tooltip:function(e){var i=t("<div>").attr("role","tooltip").addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content "+(this.options.tooltipClass||"")),n=i.uniqueId().attr("id");return t("<div>").addClass("ui-tooltip-content").appendTo(i),i.appendTo(this.document[0].body),this.tooltips[n]=e,i},_find:function(e){var i=e.data("ui-tooltip-id");return i?t("#"+i):t()},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_destroy:function(){var e=this;t.each(this.tooltips,function(i,n){var s=t.Event("blur");s.target=s.currentTarget=n[0],e.close(s,!0),t("#"+i).remove(),n.data("ui-tooltip-title")&&(n.attr("title")||n.attr("title",n.data("ui-tooltip-title")),n.removeData("ui-tooltip-title"))}),this.liveRegion.remove()}})}),$(function(){function t(t){"message"===t.type&&(o(t.text,"ok"),$("form")[0].reset()),"error"===t.type&&o(t.text,"err")}function e(t){o("Ocurrió un error al realizar la petición: "+t.statusText,"err")}function i(i){if(i.preventDefault(),!n())return o("Faltan datos obligatorios para enviar el mensaje","err"),!1;var s={userName:$("#userName").val(),userEmail:$("#userEmail").val(),tel:$("#tel").val(),userMessage:$("#userMessage").val()};$.post("contacto_formulario.php",s,t,"json").error(e)}function n(){return s($("#userName"))&&s($("#userEmail"))&&s($("#userMessage"))&&s($("#tel"))}function s(t){return t.val().trim().length>0}function o(t,e){$("#resp").html(t),$("#resp").removeClass("animated bounceOut"),$("#resp").addClass("animated bounceIn"),setTimeout(function(){$("#resp").removeClass("animated bounceIn"),$("#resp").addClass("animated bounceOut")},5e3)}$("#submit").click(i)}),function(){"use strict";({initialized:!1,initialize:function(){this.initialized||(this.initialized=!0,this.build(),this.menu(),this.carousel())},build:function(t){$(".home-slider-1 .tp-banner").each(function(){var e=$(this),i={delay:9e3,startheight:750,startwidth:960,hideThumbs:10,thumbWidth:100,thumbHeight:50,thumbAmount:5,navigationType:"both",navigationArrows:"verticalcentered",navigationStyle:"preview1",touchenabled:"on",onHoverStop:"on",navOffsetHorizontal:0,navOffsetVertical:20,stopAtSlide:0,stopAfterLoops:-1,shadow:0,fullWidth:"on",videoJsPath:"vendor/rs-plugin/videojs/"},n=$.extend({},i,t,e.data("plugin-options"));e.revolution(n).addClass("slider-init")})},menu:function(){$("#myTopnav li a, #jx-main-menu li a,.icons-section a").click(function(t){var e=$(this).attr("href");if(-1===e.indexOf("http")&&-1!==e.indexOf("#")){t.preventDefault();var i=$($(this).attr("href"));return i&&$("html, body").animate({scrollTop:i.offset().top},1e3),!1}})},carousel:function(){}}).initialize()}();var savings_Serv=function(){function t(t){return parseInt(t.toFixed(2))}function e(){return s()*y.anosSeleccionados+o()}function i(){return r()-c()}function n(){return i()*y.diasMes}function s(){return i()*y.diasAno}function o(){return a()*y.anosSeleccionados-f()*y.anosSeleccionados}function a(){return y.servAnuales*y.costoPromedioService}function r(){return y.costoCombustible*y.kmRecorridoXdia/y.rendimientoNaftaXlt}function l(){return y.kmRecorridoXdia/b.rendXCarga}function h(){return y.kmRecorridoXdia*y.diasAno}function u(){return b.precioKw*b.kwXhrXcarga}function c(){return u()*l()}function d(){return y.kmRecorridoXdia*y.diasAno/b.serviceAnualesDur}function p(){return h()/b.recambioBatDur}function f(){return d()*b.costoServicio+p()*b.recambioBatPrecio}function m(){return y.kmRecorridoXdia*y.diasAno}function g(){return e()/y.usdBill}function v(){return $.get("https://www.google.com/finance/converter?a=1&from=USD&to=UYU",function(t){var e=t.indexOf("<span class=bld>"),i=t.indexOf("UYU</span>");y.usdBill=parseFloat(t.substring(e+"<span class=bld>".length,i))})}var b={rendXCarga:100,cantCargasDiarias:.41,kwXhrXcarga:10.8,precioKw:4.5,serviceAnualesDur:5e3,costoServicio:1800,recambioBatDur:15e3,recambioBatPrecio:23200},y={kmRecorridoXdia:42,rendimientoNaftaXlt:12,costoCombustible:44,servAnuales:1,costoPromedioService:1e4,diasAno:365,diasMes:30,anosSeleccionados:5,usdBill:28};return{auto:b,datos:y,cantidadDeCargasDiarias:l,costoDeCarga:u,costosDiarios:c,serviceAnuales:d,costoTotalServicio:f,costoNaftaAnualService:a,costoDiarioNafta:r,ahorroService:o,ahorroMensual:n,ahorroAnual:s,ahorroTotalServyNaft:e,cantBatACambiar:p,kmAnuales:m,toFixed0Nr:t,getValorUsd:v,ahorroTotalUsd:g}}();!function(t){function e(){$("#rendXCarga").val(t.auto.rendXCarga),$("#precioKw").val(t.auto.precioKw),$("#costoServicio").val(t.auto.costoServicio),$("#recambioBatPrecio").val(t.auto.recambioBatPrecio)}function i(){$("#kmsxdia").text(t.datos.kmRecorridoXdia),$("#costoCombustible").val(t.datos.costoCombustible),$("#rendimientoNaftaXlt").val(t.datos.rendimientoNaftaXlt),$("#servAnuales").val(t.datos.servAnuales),$("#tiempoUsoNr").text(t.datos.anosSeleccionados),$("#tiempoUsoNr2").text(t.datos.anosSeleccionados),$("#costoPromedioService").val(t.datos.costoPromedioService)}function n(){$("#costoDeCarga").val(t.toFixed0Nr(t.costoDeCarga())),$("#serviceAnuales").val(t.toFixed0Nr(t.serviceAnuales())),$("#cantBatACambiar").val(t.toFixed0Nr(t.cantBatACambiar())),$("#costoTotalServicio").val(t.toFixed0Nr(t.costoTotalServicio())),$("#ahorroMensual").val(t.toFixed0Nr(t.ahorroMensual())),$("#ahorroAnual").val(t.toFixed0Nr(t.ahorroAnual())),$("#ahorroTotalServyNaft").val(t.toFixed0Nr(t.ahorroTotalServyNaft())),$("#ahorroService").val(t.toFixed0Nr(t.ahorroService())),$("#kmAnualesnf").text(t.toFixed0Nr(t.kmAnuales())),$("#kmAnualesem").text(t.toFixed0Nr(t.kmAnuales())),$("#ahorroTotalServyNaftUsd").val(t.toFixed0Nr(t.ahorroTotalUsd()))}$("#kmsNafta").slider({min:1,max:500,range:"min",value:t.datos.kmRecorridoXdia,slide:function(e,i){t.datos.kmRecorridoXdia=i.value-1,$("#kmsxdia").text(t.datos.kmRecorridoXdia),n()}}),$("#tiempoUso").slider({min:1,max:100,range:"min",value:t.datos.anosSeleccionados,slide:function(e,i){t.datos.anosSeleccionados=i.value-1,$("#tiempoUsoNr").text(t.datos.anosSeleccionados),$("#tiempoUsoNr2").text(t.datos.anosSeleccionados),n()}}),$("#costoCombustible,#rendimientoNaftaXlt,#servAnuales,#costoPromedioService").on("change",function(){t.datos[this.id]=this.value,n()}),function(){t.getValorUsd().then(function(){$("#ahorroTotalServyNaftUsd").val(t.toFixed0Nr(t.ahorroTotalUsd()))}),e(),i(),n()}()}(savings_Serv),function(){function t(){$(window).scrollTop()>500?$(".navbar-fixed-top").addClass("nav-up"):$(".navbar-fixed-top").removeClass("nav-up")}!function(){t(),$(window).bind("scroll",function(){t()})}()}();